...
background: "linear-gradient(180deg, #07090f, #02030a)",
boxShadow:
"0 0 0 1px rgba(255,255,255,0.08), 0 0 28px rgba(255,255,255,0.18), 0 0 80px rgba(255,255,255,0.08), 0 30px 90px rgba(0,0,0,0.75)",
};
