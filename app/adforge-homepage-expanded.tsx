...
const SERVICE_AREA_TEXT = SERVICE_AREA_NAMES.join(", ");

const homepageServiceParagraphs = [
  "We provide 24-hour mobile tyre fitting and vehicle recovery services across Liverpool, Wirral and Merseyside. Our service coverage includes Bootle, Huyton, Kirkby, Knowsley, Wallasey, Birkenhead, Sefton, Crosby, Formby, Southport, Prescot, Whiston, Halewood, Speke, Garston, St Helens, Widnes, Runcorn, Warrington, Newton-le-Willows, Rainhill and Haydock, as well as surrounding towns, villages, residential districts, business parks and major road routes.",
  "We provide mobile tyre fitting at homes, workplaces, retail parks, industrial estates, public car parks and safe roadside locations throughout the areas we cover. Drivers can contact AdForge for emergency tyre replacement, puncture repairs, new tyres, part-worn tyres, locking-wheel-nut removal and wheel balancing across Liverpool, Bootle, Huyton, Kirkby, Prescot, Speke, Widnes, St Helens, Wirral, Wallasey, Birkenhead and nearby Merseyside locations.",
  "We also provide vehicle recovery, breakdown recovery, accident recovery, towing, roadside assistance and vehicle transport across Liverpool, Wirral, Sefton, Knowsley, St Helens, Widnes, Runcorn, Warrington and surrounding areas. Recovery can be arranged from residential streets, workplaces, garages, shopping areas, motorway junctions and other accessible locations when a car, van or light commercial vehicle cannot be driven safely.",
  "Our coverage is not limited to Liverpool city centre. We provide tyre fitting and recovery services throughout North Liverpool, South Liverpool, Knowsley, Sefton, the Wirral peninsula and nearby parts of Cheshire. This includes regular coverage around Bootle, Crosby, Formby, Southport, Huyton, Kirkby, Prescot, Whiston, Halewood, Speke, Garston, Wallasey, Birkenhead, Widnes, Runcorn, St Helens, Warrington, Rainhill, Haydock and Newton-le-Willows.",
];

const baseTyreSeoParagraphs = [
  {
...
const tyreSeoParagraphs = baseTyreSeoParagraphs.map((item, index) => ({
  ...item,
  paragraphs: [
    ...item.paragraphs,
    index % 3 === 0
      ? `We provide ${item.title.toLowerCase()} across ${SERVICE_AREA_TEXT}. Customers in these areas can request tyre assistance at home, at work, in a car park or at a safe roadside location, subject to local availability, tyre size and access.`
      : index % 3 === 1
        ? `This mobile tyre service is available throughout Liverpool, Wirral, Bootle, Huyton, Kirkby, Knowsley, Wallasey, Birkenhead, Sefton, Crosby, Formby, Southport, Prescot, Whiston, Halewood, Speke, Garston, St Helens, Widnes, Runcorn, Warrington and surrounding Merseyside areas.`
        : `We regularly provide mobile tyre fitting across the wider Liverpool City Region, including residential districts, town centres, business parks, industrial estates and major routes serving ${SERVICE_AREA_TEXT}.`,
  ],
}));

const baseRecoverySeoParagraphs = [
  {
...
const recoverySeoParagraphs = baseRecoverySeoParagraphs.map((item, index) => ({
  ...item,
  paragraphs: [
    ...item.paragraphs,
    index % 3 === 0
      ? `We provide ${item.title.toLowerCase()} across ${SERVICE_AREA_TEXT}. Recovery can be arranged from homes, workplaces, garages, retail parks, industrial estates and safe roadside locations, depending on vehicle condition and access.`
      : index % 3 === 1
        ? `Our recovery coverage regularly includes Liverpool, Wirral, Bootle, Huyton, Kirkby, Knowsley, Wallasey, Birkenhead, Sefton, Crosby, Formby, Southport, Prescot, Whiston, Halewood, Speke, Garston, St Helens, Widnes, Runcorn, Warrington and surrounding areas.`
        : `We provide vehicle recovery throughout the wider Liverpool City Region and nearby Cheshire areas, covering local streets, town centres, business parks and major road routes serving ${SERVICE_AREA_TEXT}.`,
  ],
}));
  ...
  return (
    <>
      <main className="page">
          ...
          <div className="heroGrid">
            <div className="heroCopy">
              ...
              <p className="heroLead">
                We provide 24-hour mobile tyre fitting and vehicle recovery
                services through AdForge across Liverpool, Wirral and Merseyside.
                We provide emergency tyre repair, puncture repairs, mobile tyres,
                new and part-worn tyres, breakdown recovery, towing and roadside
                assistance throughout Bootle, Huyton, Kirkby, Knowsley, Wallasey,
                Birkenhead, Sefton, Crosby, Formby, Southport, Prescot, Whiston,
                Halewood, Speke, Garston, St Helens, Widnes, Runcorn, Warrington
        ...
        <section className="splitServices">
          <article className="splitCard tyreCard">
            ...
            <div className="splitContent">
              ...
              <p>
                We provide emergency mobile tyre fitting, puncture repairs,
                emergency tyre repair, roadside tyre replacement, mobile tyres,
                new and part-worn tyres, wheel balancing and locking-wheel-nut
                removal across Liverpool, Wirral, Bootle, Huyton, Kirkby,
                Prescot, Speke, St Helens, Widnes and surrounding areas.
              </p>
          ...
          <article className="splitCard recoveryCard">
            <div className="splitContent">
              ...
              <p>
                We provide 24-hour vehicle recovery, breakdown recovery,
                accident recovery, towing, roadside assistance and vehicle
                transport through AdForge across Liverpool, Wirral, Bootle,
                Huyton, Kirkby, Knowsley, Wallasey, Birkenhead, Sefton,
                St Helens, Widnes, Runcorn, Warrington and nearby areas.
              </p>
        ...
        <section className="coverageContent" id="coverage-details">
          <div className="sectionIntro wide">
            <span>AREAS WE REGULARLY SERVICE</span>
            <h2>We provide tyre fitting and recovery throughout the region.</h2>
            <p>
              Our mobile services cover Liverpool, Wirral, Merseyside and the
              surrounding towns regularly used by local drivers and businesses.
            </p>
          </div>

          <div className="coverageParagraphs">
            {homepageServiceParagraphs.map((paragraph) => (
          ...
          <div className="coverageAreaGrid">
            {SERVICE_AREA_NAMES.map((area) => (
              <span key={area}>We provide services in {area}</span>
            ))}
          </div>
        </section>
        ...
        <footer className="footer">
          ...
          <p>
            We provide mobile tyre fitting, vehicle recovery and trusted local
            services across Liverpool, Wirral, Merseyside and surrounding areas.
          </p>
